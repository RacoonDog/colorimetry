...
public class ARRPUtil {
    ...
    public static void addBlockState(Identifier id, String template, RuntimeResourcePack RRP) {
        RRP.addBlockState(state(variant(model(new StringBuilder(id.getNamespace()).append(":block/").append(template.toLowerCase()).toString()))), id);
    }
    public static void addBlockItemModel(Identifier id, String template, RuntimeResourcePack RRP) {
        RRP.addModel(JModel.model(new StringBuilder(id.getNamespace()).append(":block/").append(template.toLowerCase()).toString()), StringUtil.prefixPath(id, "item/"));
    }
